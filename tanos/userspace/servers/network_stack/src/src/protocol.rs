...
impl Socket {
    pub fn new(id: SocketId, socket_type: SocketType, protocol: u32, owner: ProcessId) -> Self {
        Self {
            ...
            owner,
            tcp_seq: 1000, // Random initial sequence number
            tcp_ack: 0,
            recv_buffer: Vec::new(),
            send_buffer: Vec::new(),
        }
